...
const int mosfetB = 3; // Low-side MOSFET A'
const int mosfetC = 4; // High-side MOSFET B
const int mosfetD = 5; // Low-side MOSFET B'
const int mosfetE = 6; // High-side MOSFET C
